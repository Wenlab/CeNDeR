...
class neuron_data_pytorch(Dataset):
    ...
    def __init__(self, path, batch_sz, shuffle, rotate = False, mode = 'all', ref_idx = 0, show_name = False, shuffle_pt = True, tmp_path = None, pt_mode = False):
        """
    ...
    def custom_collate_fn(self, bundle):
        ...
        if self.tmp_path is not None:
            ...
            if self.pt_mode:
                ...
                pt_batch.append(pt[:, 1:])
                label_batch.append(pt[:, 0])
